...
public class Main extends Application {
	...
	public static final String MEAL_HISTORY_WINDOW = "view/codebehind/MealHistoryWindow.fxml";
	public static final String MEAL_HISTORY_WINDOW_TITLE = "bloomProject Meal History";
